...
function descrever_cla($numero_elfo){
        ...
        if ($numero_elfo == 1){
            ...
            Depois da Guerra da Ira, Sindar que ficaram na Terra-Média construiram os portos cinzentos em Lindon e, depois, sob a liderança de Celeborn, foram para Eriador. Mas houve os que foram ainda mais pro leste, cruzaram as montanhas sombrias e se misturaram com seus parentes os elfos selvagens. Um destes foi Amdír, fundador de um reino em Lórien (governada por Galadriel e seu marido durante os eventos de o Senhor dos Anéis).
